...
// Wide toggle groups (surface/font/base) can overflow the drawer width, and
...
// The five theme axes as a self-contained control panel — no surrounding chrome,
// so it can live in the header Sheet (see ThemeSheet) without assuming a layout.
// All state is the shared store (theme.ts via useSyncExternalStore), so this
// re-renders in sync with the OS-theme listener and the pre-paint script.
